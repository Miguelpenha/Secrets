...
interface Iprops {
    ...
    setOpenModalCreateType: Dispatch<SetStateAction<boolean>>
}

const ModalizeSelectType: FC<Iprops> = ({ modalize, setOpenModalize, setTypeSelect, setOpenModalCreateType }) => {
    ...
    return (
        ...
        >
            <ButtonCreateAnimated onPress={() => {
                modalize.current.close()

                setOpenModalCreateType(true)
            }}/>
            <Types>
